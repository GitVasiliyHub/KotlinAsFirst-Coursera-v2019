...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    return ((sagenes * 48).toDouble() + (arshins.toDouble() * 48.0 / 3.0) + vershoks)* 4.445 / 100
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val y = 3.0
    val x: Double = (1.0 + percent.toDouble() / 100.0).pow(y)
    return initial.toDouble() * x
...
fun numberRevert(number: Int): Int {
    ...
    val answer: String = x3.toString() + x2.toString() + x1.toString()
    return answer.toInt()
}
